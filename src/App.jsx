...
function GameDashboard({ logout, user }) {
  ...
  const [showTerms, setShowTerms] = useState(false); // NEW STATE FOR TERMS
      ...
      {showUserBids && (
        <div className="modal-overlay">
          <div className="glass-card modal-content fade-in" style={{textAlign:'left'}}>
            ...
            <h2 style={{color: '#3b82f6', textAlign:'center', marginTop:0}}>MY BIDS</h2>
            <div style={{maxHeight:'300px', overflowY:'auto'}}>
        ...
        <div className="modal-overlay">
          <div className="glass-card modal-content fade-in" style={{textAlign:'left'}}>
            ...
            <p style={{fontSize:'10px', color:'#94a3b8', marginTop:'10px', textAlign:'center'}}>
               🛡️ Security Notice: Withdrawals are subject to automated security checks and typically process within 10-60 minutes.
            </p>
